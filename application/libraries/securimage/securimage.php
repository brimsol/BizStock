...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->wordlist_file = './application/libraries/securimage/words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = './application/libraries/securimage/gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = './application/libraries/securimage/AHGBold.ttf';
		...
		$this->image_bg_color   = new Securimage_Color(0xE9, 0xE9, 0xE9);
    $this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->num_lines            = 10;
		$this->line_color           = new Securimage_Color(0xE9, 0xE9, 0xE9);
		$this->draw_lines_over_text = true;

		$this->image_signature = '';
		$this->signature_color = new Securimage_Color(0x20, 0x50, 0xCC);
		$this->signature_font  = './application/libraries/securimage/AHGBold.ttf';

		$this->audio_path   = './application/libraries/securimage/audio/';
		$this->audio_format = 'mp3';
		$this->session_name = '';
		$this->expiry_time  = 900;
		
		$this->sqlite_database = './application/libraries/securimage/database/securimage.sqlite';
